...
<html>
<head>
    <title>Gestión de Terapias</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/adminterapia.css">
</head>
...
<div class="container py-4">
  ...
  <!-- Barra superior -->
    ...
    <!-- Título -->
    <h2 class="mb-4 text-center">Gestión de Terapias</h2>
    
     <!-- ALERTA SI HAY ERROR DE RESERVA -->
    <c:if test="${errorReserva == true}">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <i class="bi bi-exclamation-triangle-fill me-2"></i>
            No se puede borrar la terapia porque tiene reservas activas.
    ...
    <div class="text-end mb-3">
        <a href="${pageContext.request.contextPath}/admin/terapistas" class="btn btn-outline-success">
            <i class="bi bi-eye-fill me-2"></i> Mostrar Terapias
        </a>
    </div>
    ...
    <div class="text-end mb-3">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCrear">
            <i class="bi bi-plus-circle me-2"></i> Nueva Terapia
        </button>
    </div>
                ...
                <c:forEach var="t" items="${listaTerapias}">
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <!-- Eliminar -->
                            <a href="${pageContext.request.contextPath}/admin/terapias?action=delete&id=${t.id}"
                               class="btn btn-danger btn-sm"
                               onclick="return confirm('¿Eliminar esta terapia?');">
...
<div class="modal fade" id="modalCrear" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="${pageContext.request.contextPath}/admin/terapias">
            <input type="hidden" name="action" value="create">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Nueva Terapia</h5>
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="${pageContext.request.contextPath}/admin/terapias">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Editar Terapia</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <label>Nombre</label>
                    ...
                    <label>Descripción</label>
                    <textarea name="descripcion" id="edit-descripcion" class="form-control mb-3" required></textarea>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
